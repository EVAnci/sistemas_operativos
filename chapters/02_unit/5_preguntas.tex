...
\begin{enumerate}
  ...
  \item ¿Qué significa que un proceso sea apropiado (preempted)?
  ...
  \item ¿Cuál es la diferencia entre una interrupción (interrupt) y una excepción o trap?
...
Un programa es un conjunto de instrucciones almacenadas en memoria. Un proceso es un programa en ejecución, junto con sus datos, recursos y contexto de ejecución administrados por el sistema operativo.
...
Significa que el sistema operativo interrumpe temporalmente su ejecución para asignar el procesador a otro proceso, normalmente por expiración del quantum o por la llegada de un proceso de mayor prioridad.
...
Un cambio de modo modifica únicamente el nivel de privilegio del procesador (usuario ↔ kernel), mientras continúa ejecutándose el mismo proceso.
