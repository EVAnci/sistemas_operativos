...
\begin{figure}[!ht]
  \centering
  \includegraphics[width=.8\textwidth]{chapters/03_unit/media/queue_priority.pdf}
...
\vspace{0.2cm} 
% Ajusté un poco el ancho de la primera columna a 2.5cm para dar más espacio a las demás
\begin{tabularx}{\textwidth}{@{} >{\raggedright\arraybackslash}p{2.5cm} *{6}{>{\centering\arraybackslash}X} @{}}
\toprule
...
\[
  \text{TAT} = \text{Tiempo de espera} + \text{Tiempo de servicio}.
\]
...
Para visualizar cada algoritmo se utilizará un diagrama ejemplificando cómo se ejecutan los procesos del cuadro \ref{tab:pr_ej}.
...
\begin{table}
  ...
  \begin{tabular}{c|c|c}
    ...
    \hline
    \textbf{A} & 3 & 0 \\ 
    \color{green!60!black} \textbf{B} & 6 & 2 \\ 
    \color{blue!60!red} \textbf{C} & 4 & 4 \\ 
    \color{red!70!black} \textbf{D} & 5 & 6 \\ 
    \color{blue!60} \textbf{E} & 2 & 8 \\ 
    \hline
    Total & 20 & -
  \end{tabular}
  \caption{Procesos de ejemplo}
  \label{tab:pr_ej}
\end{table}
...
\begin{figure}[!ht]
  ...
  \begin{tikzpicture}
    \foreach \x in {0,5,10,15} {
      \draw ({\x/2},0) -- ({\x/2},3.4) node[above]{\x};
      \foreach \t in {1,2,3,4} {
        \draw[dashed] ({(\x/2+\t/2},0) -- ({\x/2+\t/2},3.4);
      }
    }
    \draw (10,0) -- (10,3.4) node[above]{20};
    \draw (0,3) -- (10,3);

    \foreach \y\t\c in {.25/E/blue!60,.75/D/red!70!black,1.25/C/blue!60!red,1.75/B/green!60!black,2.25/A/black} {
      \node[left,color=\c] at(0,\y) {\t};
    }

    \draw[fill=yellow!6,very thick] (0,2.5) rectangle ({3/2},2);
    \draw[green!60!black,fill=yellow!6,very thick] ({3/2},2) rectangle ({9/2},1.5);
    \draw[blue!50!red,fill=yellow!6,very thick] ({9/2},1.5) rectangle ({13/2},1);
    \draw[red,fill=yellow!6,very thick] ({13/2},1) rectangle (9,.5);
    \draw[blue,fill=yellow!6,very thick] (9,.5) rectangle (10,0);
  \end{tikzpicture}
  \caption{Ejemplo de ejecución de procesos usando FCFS.}
\end{figure}
...
\begin{figure}[!ht]
  ...
  \begin{tikzpicture}
    ...
    \draw[fill=yellow!6,very thick] (0,2.5) rectangle (1,2);
    \draw[green!60!black,fill=yellow!6,very thick] (1,2) rectangle ({3/2},1.5);
    \draw[fill=yellow!6,very thick] ({3/2},2.5) rectangle (2,2);
    \draw[green!60!black,fill=yellow!6,very thick] (2,2) rectangle ({5/2},1.5);
    \draw[blue!50!red,fill=yellow!6,very thick] ({5/2},1.5) rectangle (3,1);
    \draw[green!60!black,fill=yellow!6,very thick] (3,2) rectangle ({7/2},1.5);
    \draw[red,fill=yellow!6,very thick] ({7/2},1) rectangle (4,.5);
    \draw[blue!50!red,fill=yellow!6,very thick] (4,1.5) rectangle ({9/2},1);
    \draw[green!60!black,fill=yellow!6,very thick] ({9/2},2) rectangle (5,1.5);
    \draw[blue,fill=yellow!6,very thick] (5,.5) rectangle ({11/2},0);
    \draw[red,fill=yellow!6,very thick] ({11/2},1) rectangle (6,.5);
    \draw[blue!50!red,fill=yellow!6,very thick] (6,1.5) rectangle ({13/2},1);
    \draw[green!60!black,fill=yellow!6,very thick] ({13/2},2) rectangle (7,1.5);
    \draw[blue,fill=yellow!6,very thick] (7,.5) rectangle ({15/2},0);
    \draw[red,fill=yellow!6,very thick] ({15/2},1) rectangle (8,.5);
    \draw[blue!50!red,fill=yellow!6,very thick] (8,1.5) rectangle ({17/2},1);
    \draw[green!60!black,fill=yellow!6,very thick] ({17/2},2) rectangle (9,1.5);
    \draw[red,fill=yellow!6,very thick] (9,1) rectangle (10,.5);
  \end{tikzpicture}
  \caption{Ejemplo de ejecución de procesos usando RR con \(q=1\).}
\end{figure}
...
\begin{figure}[!ht]
  ...
  \begin{tikzpicture}
    ...
    \draw[fill=yellow!6,very thick] (0,2.5) rectangle ({3/2},2);
    \draw[green!60!black,fill=yellow!6,very thick] ({3/2},2) rectangle ({9/2},1.5);
    \draw[blue,fill=yellow!6,very thick] ({9/2},.5) rectangle ({11/2},0);
    \draw[blue!50!red,fill=yellow!6,very thick] ({11/2},1.5) rectangle ({15/2},1);
    \draw[red,fill=yellow!6,very thick] ({15/2},1) rectangle (10,.5);
  \end{tikzpicture}
  \caption{Ejemplo de ejecución de procesos usando SPN.}
\end{figure}
...
\begin{figure}[!ht]
  ...
  \begin{tikzpicture}
    ...
    \draw[fill=yellow!6,very thick] (0,2.5) rectangle ({3/2},2);
    \draw[green!60!black,fill=yellow!6,very thick] ({3/2},2) rectangle (2,1.5);
    \draw[blue!50!red,fill=yellow!6,very thick] (2,1.5) rectangle (4,1);
    \draw[blue,fill=yellow!6,very thick] (4,.5) rectangle (5,0);
    \draw[green!60!black,fill=yellow!6,very thick] (5,2) rectangle ({15/2},1.5);
    \draw[red,fill=yellow!6,very thick] ({15/2},1) rectangle (10,.5);
  \end{tikzpicture}
  \caption{Ejemplo de ejecución de procesos usando SRT.}
\end{figure}
...
\begin{figure}[!ht]
  ...
  \begin{tikzpicture}
    ...
    \draw[green!60!black,fill=yellow!6,very thick] ({3/2},2) rectangle ({9/2},1.5);
    \draw[blue!50!red,fill=yellow!6,very thick] ({9/2},1.5) rectangle ({13/2},1);
    \draw[blue,fill=yellow!6,very thick] ({13/2},.5) rectangle ({15/2},0);
    \draw[red,fill=yellow!6,very thick] ({15/2},1) rectangle (10,.5);
  \end{tikzpicture}
  \caption{Ejemplo de ejecución de procesos usando HRRN.}
\end{figure}
...
\begin{figure}[!ht]
  ...
  \begin{tikzpicture}
    ...
    \draw[green!60!black,fill=yellow!6,very thick] (1,2) rectangle ({3/2},1.5);
    \draw[fill=yellow!6,very thick] ({3/2},2.5) rectangle (2,2);
    \draw[blue!50!red,fill=yellow!6,very thick] (2,1.5) rectangle ({5/2},1);
    \draw[green!60!black,fill=yellow!6,very thick] ({5/2},2) rectangle (3,1.5);
    \draw[red,fill=yellow!6,very thick] (3,1) rectangle ({7/2},.5);
    \draw[blue!50!red,fill=yellow!6,very thick] ({7/2},1.5) rectangle (4,1);
    \draw[blue,fill=yellow!6,very thick] (4,.5) rectangle ({9/2},0);
    \draw[red,fill=yellow!6,very thick] ({9/2},1) rectangle (5,.5);
    \draw[blue,fill=yellow!6,very thick] (5,.5) rectangle ({11/2},0);
    \draw[green!60!black,fill=yellow!6,very thick] ({11/2},2) rectangle (6,1.5);
    \draw[blue!50!red,fill=yellow!6,very thick] (6,1.5) rectangle ({13/2},1);
    \draw[red,fill=yellow!6,very thick] ({13/2},1) rectangle (7,.5);
    \draw[green!60!black,fill=yellow!6,very thick] (7,2) rectangle ({15/2},1.5);
    \draw[blue!50!red,fill=yellow!6,very thick] ({15/2},1.5) rectangle (8,1);
    \draw[red,fill=yellow!6,very thick] (8,1) rectangle ({17/2},.5);
    \draw[green!60!black,fill=yellow!6,very thick] ({17/2},2) rectangle (9,1.5);
    \draw[red,fill=yellow!6,very thick] (9,1) rectangle ({19/2},.5);
    \draw[green!60!black,fill=yellow!6,very thick] ({19/2},2) rectangle (10,1.5);
  \end{tikzpicture}
  \caption{Ejemplo de ejecución de procesos usando FCFS.}
\end{figure}
...
\begin{figure}[!ht]
  \centering
  \includegraphics[width=0.8\textwidth]{chapters/03_unit/media/fair_share.pdf}
