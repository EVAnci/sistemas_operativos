...
\begin{itemize}
  \item \textbf{Recursos asignados} (\(A_{ij}\)): recursos actualmente asignados a cada proceso.
  \item \textbf{Recursos disponibles} (\(V\)): recursos disponibles de cada tipo.
  \item \textbf{Recursos solicitados} (\(Q\)): recursos adicionales que cada proceso necesita para finalizar.
\end{itemize}
