...
Una forma de satisfacer ambos requisitos es mediante el \textit{paso de mensajes}, donde los procesos se comunican enviando y recibiendo mensajes, sin necesidad de compartir memoria.
