...
\begin{figure}[!ht]
  ...
  \begin{tikzpicture}
    ...
    \node[above] at (4.9,4.5) {Volumen RAID 60};
...
\begin{table}[!ht]
  \centering
  \begin{tabular}{l|c}
    Cantidad de discos mínima & 8 \\\hline
    Cantidad de discos que pueden fallar & 4 (2\(\times\)RAID 6) \\ \hline
    ...
    Costo & Alto
  \end{tabular}
  \caption{Características del RAID 60.}
  \label{tab:raid60}
\end{table}

En el cuadro \ref{tab:raid60} \(M\) es la cantidad de arreglos RAID 6 que tiene el volumen RAID 60. Por ejemplo, en la figura \ref{fig:raid60}, \(M=2\) porque hay dos arreglos RAID 6.
