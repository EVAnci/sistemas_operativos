...
La memoria debe organizarse de forma que refleje la estructura lógica de los programas. En general, las aplicaciones se desarrollan como un conjunto de módulos (funciones, bibliotecas, procedimientos o clases), cada uno con un propósito específico. Esta organización permite asignar distintos niveles de protección a cada módulo, por ejemplo, estableciendo regiones de solo lectura para evitar modificaciones accidentales o permisos de solo ejecución para el código. Además, la división modular facilita la compartición de módulos entre varios procesos, reduciendo el uso de memoria y favoreciendo la reutilización de código, como ocurre con las bibliotecas compartidas.
