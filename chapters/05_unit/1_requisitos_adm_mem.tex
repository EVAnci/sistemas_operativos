...
Además, el procesador debe manejar las referencias a memoria dentro del programa: las instrucciones de salto incluyen una dirección de la siguiente instrucción a ejecutar; y las instrucciones de acceso a datos contienen la dirección del byte o palabra de datos referenciado. 
